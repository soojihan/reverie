...
<p style="text-align:left;font-weight:bold;font-size:20px;line-height:1.0">Explainable Depression Detection on Social Media</p>
...
<p style="text-align:left;font-weight:bold;font-size:20px;line-height:1.0">Human-Robot Collaborative Al for Advanced Manufacturing and Engineering, S$1,962,800 (Oct 2021-present)</p>
...
<p style="text-align:left;font-weight:bold;font-size:20px;line-height:1.0">Governmental Requests for Information Decomposition, Undisclosed amount (Jan-Mar 2022)</p>
...
<p style="text-align:left;font-weight:bold;font-size:20px;line-height:1.0">Bot/Cyborg detection, Undisclosed amount (Jan 2020-March 2022)</p>
...
<p style="text-align:left;font-weight:bold;font-size:20px;line-height:1.0">Context-aware message-level rumour detection with weak supervision</p>
...
<p class="mine">The aim is to study whether identifying rumours before they go viral is possible and develop an architecture for ERD at individual post level. To this end, it first explores the following three major bottlenecks of state-of-the-art ERD:<br>
<ol>
...
<p style="text-align:left;font-weight:bold;font-size:20px;line-height:1.0"><a href="http://setamobility.eu/" target="_blank">SETA</a>: ubiquitous data and service ecosystem for better metropolitan mobility</p>
...
<p style="text-align:left;font-weight:bold;font-size:20px;line-height:1.0"><a href="https://footballwhispers.com/" target="_blank">Football Whispers</a></p>
